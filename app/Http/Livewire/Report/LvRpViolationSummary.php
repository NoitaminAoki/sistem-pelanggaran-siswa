...
class LvRpViolationSummary extends Component
{
    ...
    public function render()
    {
        return view('livewire.report.lv-rp-violation-summary')
            ...
            ->layout('layouts.cms.lv-main', ['menuName' => 'report_violation_summary']);
    }
    ...
    {
        try {
            $response = Excel::download(new ReportViolationSummaryExport($this->filters), "laporan pelanggaran keseluruhan - {$this->filters['startDate']} sampai {$this->filters['endDate']}.xlsx");

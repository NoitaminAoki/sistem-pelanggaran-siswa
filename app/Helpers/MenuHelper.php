...
class MenuHelper
{
    static $MENU = [
        ...
        [
            ...
            'route_validate' => ['report.violation'],
        ...
        [
            'title' => 'Pelanggaran (Summary)',
            'sub_title' => '',
            'name' => 'report_violation_summary',
            'root' => 'laporan',
            'route_name' => 'report.violation.summary',
            'route_validate' => ['report.violation.summary'],
            'icon_class' => 'fas fa-file-alt',
            'breadcrumb' => [
                ['name' => 'home', 'has_link' => true, 'route_name' => 'admin.dashboard'],
                ['name' => 'report', 'has_link' => false],
                ['name' => 'violation (summary)', 'has_link' => false],
            ],
            'branch' => [],
        ],
        [

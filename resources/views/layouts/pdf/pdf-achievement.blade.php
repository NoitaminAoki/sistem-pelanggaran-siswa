    ...
    <table class="table table-bordered cs-table-border text-desc" width="100%">
        <thead> 
            <tr>
                ...
                <th scope="col" class="text-center align-middle bg-yellow">Prestasi</th>
                <th scope="col" class="text-center align-middle bg-yellow">Poin Prestasi</th>
                <th scope="col" class="text-center align-middle bg-yellow">Keterangan</th>

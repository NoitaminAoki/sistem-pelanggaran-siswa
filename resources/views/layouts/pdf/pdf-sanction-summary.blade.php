    ...
    <table class="table table-bordered cs-table-border text-desc" width="100%">
        <thead> 
            <tr>
                ...
                <th scope="col" class="text-center align-middle bg-yellow">Sanksi (Ringan)</th>
                <th scope="col" class="text-center align-middle bg-yellow">Sanksi (Sedang)</th>
                <th scope="col" class="text-center align-middle bg-yellow">Sanksi (Berat)</th>
                <th scope="col" class="text-center align-middle bg-yellow">Total Sanksi</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"> {{$item->total_sanksi_ringan}} </td>
                <td class="text-center"> {{$item->total_sanksi_sedang}} </td>
                <td class="text-center"> {{$item->total_sanksi_berat}} </td>
                <td class="text-center"> {{$item->total_sanksi}} </td>
            </tr>
            @endforeach
        </tbody>

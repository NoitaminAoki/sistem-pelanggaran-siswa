    ...
    <table class="table table-bordered cs-table-border text-desc" width="100%">
        <thead> 
            <tr>
                ...
                <th scope="col" class="text-center align-middle bg-yellow">Pelanggaran</th>
                <th scope="col" class="text-center align-middle bg-yellow">Jenis Pelanggaran</th>
                <th scope="col" class="text-center align-middle bg-yellow">Catatan</th>

        ...
        <thead>
            <tr>
                <th class="text-center border-0">
                    ...
                    <b class="text-caption-start">Laporan Pelanggaran Siswa (<i>Summary</i>)</b><br>
    ...
    <table class="table table-bordered cs-table-border text-desc" width="100%">
        <thead> 
            <tr>
                ...
                <th scope="col" class="text-center align-middle bg-yellow">NIS</th>
                <th scope="col" class="text-center align-middle bg-yellow">Nama Siswa</th>
                <th scope="col" class="text-center align-middle bg-yellow">Pelanggaran (Ringan)</th>
                <th scope="col" class="text-center align-middle bg-yellow">Pelanggaran (Sedang)</th>
                <th scope="col" class="text-center align-middle bg-yellow">Pelanggaran (Berat)</th>
                <th scope="col" class="text-center align-middle bg-yellow">Total Pelanggaran</th>
                <th scope="col" class="text-center align-middle bg-yellow">Total Poin</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"> {{$item->total_pelanggaran_ringan}} </td>
                <td class="text-center"> {{$item->total_pelanggaran_sedang}} </td>
                <td class="text-center"> {{$item->total_pelanggaran_berat}} </td>

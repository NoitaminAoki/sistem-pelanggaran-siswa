        ...
        <thead>
            <tr>
                <th class="text-center border-0">
                    ...
                    <b class="text-caption-start">Laporan Peringkat Siswa Terbaik</b><br>
    ...
    <table class="table table-bordered cs-table-border text-desc" width="100%">
        <thead> 
            <tr>
                ...
                <th scope="col" class="text-center align-middle bg-yellow">Total Prestasi</th>
                <th scope="col" class="text-center align-middle bg-yellow">Total Poin Prestasi</th>
                ...
                <th scope="col" class="text-center align-middle bg-yellow">Poin Akhir</th>
            </tr>
        </thead>
        <tbody>

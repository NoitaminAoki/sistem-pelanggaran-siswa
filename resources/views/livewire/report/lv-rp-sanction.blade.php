    ...
    $(document).ready(function() {
        tStdReport = $('#tStdReport').DataTable({
            ...
            ajax: {
                ...
                url: "{{ route('report.sanction.datatables') }}",
                data: function (d) {
            ...
            { data: 'nama_sanksi', name: 'sanctions.nama_sanksi' },
            { data: 'jenis_sanksi', name: 'sanctions.nama_sanksi' },
            { data: 'catatan', name: 'catatan' },
            { data: 'tanggal_sanksi', name: 'tanggal_sanksi' },
            ],
        }).on('draw', function() {
